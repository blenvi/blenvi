...
export default function TeamProjectSelector() {
    ...
    if (teams.length === 0) {
      return (
        <Alert>
          ...
          <AlertDescription>
            No teams available. Contact your administrator to get access to a
            team.
          </AlertDescription>
        </Alert>
      );
    ...
    if (projects.length === 0) {
      return (
        <Alert>
          <IconAlertCircle className="h-4 w-4" />
          <AlertDescription>
            No projects found in {selectedTeam.name}. Create a new project to
            get started.
          </AlertDescription>
        </Alert>
      );
  ...
  return (
    <div className="container max-w-5xl mx-auto py-8 px-4 lg:px-6">
      {/* Header */}
      <div className="text-center mb-8">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-2">
          Select a team and project to start working. You can create new teams
          and projects if needed.
        </p>
      </div>
