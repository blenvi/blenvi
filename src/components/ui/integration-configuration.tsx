          ...
          <Tabs defaultValue="configuration" className="w-full">
            ...
            <TabsContent value="configuration" className="space-y-6">
              <Alert>
                ...
                <AlertDescription>
                  Update your {selectedIntegration.name} configuration. Changes
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-2">
                  ...
                  >
                    ...
                    : <IconFlask2 className="h-4 w-4 mr-2" />}
                    Test Connection
                  </Button>
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute right-1 top-1 flex space-x-1">
                        ...
                        <Button
                          ...
                          className="h-7 w-7 p-0"
                          onClick={() =>
                            copyToClipboard("whsec_1234567890abcdef")
                          }
                        >
                          <IconCopy className="h-3 w-3" />
                        </Button>
            ...
            <TabsContent value="monitoring" className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Monitor the performance and health of your{" "}
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Progress
                      value={selectedIntegration.health}
                      className="mt-2"
                    />
                  </CardContent>
                </Card>
