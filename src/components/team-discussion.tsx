...
const discussions = [
  ...
  },
  {
    ...
    avatar: '/placeholder.svg?height=32&width=32',
    message: "Found a small bug in the data table sorting. I'll create a ticket and fix it by EOD.",
    ...
    <div className="px-4 lg:px-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Stay connected with your team members</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div key={discussion.id} className="space-y-3">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <p className="text-foreground text-sm">{discussion.message}</p>
                          ...
                          {discussion.replies.map(reply => (
                            <div key={reply.id} className="flex space-x-2">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-foreground text-xs">{reply.message}</p>
                              </div>
                            </div>
                          ))}
                        </div>
