      ...
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <section>
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            ...
            managed by Supabase. For detailed information about how Supabase
            processes and protects your data, please review their{" "}
            <a
        ...
        <section>
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            Blenvi is an open-source project that is still under active
            development. Deployments may be experimental and data may be reset
            during maintenance or schema changes. Avoid entering sensitive
            production secrets unless you are operating your own trusted
            deployment.
          </p>
        </section>
